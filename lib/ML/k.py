...
def train():
    ...
    a = pd.read_csv(r'lib\ML\data_fin.csv')
    ...
    f = open(r'lib\ML\MultinomialNB.pickle', 'wb')
    pickle.dump(classifier, f)
    f.close()
    f = open(r'lib\ML\tfidf.pickle','wb')
    pickle.dump(tfidf, f)
    f.close()

def predict(data):
    f = open(r'lib\ML\MultinomialNB.pickle', 'rb')
    classifier = pickle.load(f)
    f.close()
    f = open(r'lib\ML\tfidf.pickle','rb')
    tfidf = pickle.load(f)
    f.close()
    # data = np.array(data)
